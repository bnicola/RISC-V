read_sdc -scenario "timing_analysis" -netlist "optimized" -pin_separator "/" -ignore_errors {C:/Libero_Projects/PF_Mi_V_Tut/designer/top/timing_analysis.sdc}
set_options -analysis_scenario "timing_analysis" 
save
set has_violations {C:\Libero_Projects\PF_Mi_V_Tut\designer\top\top_has_violations}
set fp [open $has_violations w]
set coverage [report \
    -type     constraints_coverage \
    -format   xml \
    -slacks   no \
    {C:\Libero_Projects\PF_Mi_V_Tut\designer\top\top_timing_constraints_coverage.xml} ]
puts $fp "_timing_constraints_coverage $coverage"
report \
    -type     combinational_loops \
    -format   xml \
    {C:\Libero_Projects\PF_Mi_V_Tut\designer\top\top_timing_combinational_loops.xml}
report_timing \
    -delay_type     max \
    -max_paths  1000 \
    -file      \
    {C:\Libero_Projects\PF_Mi_V_Tut\designer\top\max_report.json}
report_timing \
    -delay_type     min \
    -max_paths  1000 \
    -file      \
    {C:\Libero_Projects\PF_Mi_V_Tut\designer\top\min_report.json}
...
set max_timing_violations_multi_corner [report \
    ...
    {C:\Libero_Projects\PF_Mi_V_Tut\designer\top\top_max_timing_violations_multi_corner.xml} ]
...
set max_timing_multi_corner [report \
    ...
    -max_parallel_paths  1 \
    {C:\Libero_Projects\PF_Mi_V_Tut\designer\top\top_max_timing_multi_corner.xml} ]
...
set min_timing_violations_multi_corner [report \
    ...
    -max_expanded_paths  0 \
    -max_parallel_paths  1 \
    {C:\Libero_Projects\PF_Mi_V_Tut\designer\top\top_min_timing_violations_multi_corner.xml} ]
...
set min_timing_multi_corner [report \
    ...
    -max_expanded_paths  1 \
    -max_parallel_paths  1 \
    {C:\Libero_Projects\PF_Mi_V_Tut\designer\top\top_min_timing_multi_corner.xml} ]
